...
describe('HorizontalRangeBar', () => {
    ...
    test('renders properly into dom progress number', () => {
        const component = mount(<HorizontalRangeBar progress={20}/>);
    ...
    test('renders properly with percentage even when the range is not 0-100', () => {
        const component = mount(<HorizontalRangeBar progress={500} range={[0, 1000]}/>);
    ...
    //     const component = mount(<HorizontalRangeBar progress={20} range={[0, 10]}/>);
