...
export interface INumberLabelProps {
    ...
    /** override NumberLabel styles */
    style?: React.CSSProperties;

    /** override NumberLabel class */
    className?: string;
...
export default class NumberLabel extends React.Component<INumberLabelProps, {}> {
    static defaultProps = {
        abbrAccuracy: 1,
        className: '',
        style: {},
    ...
    render() {
        ...
        return (
            <span style={style} className={`number-label-component ${styles.label} ${className}`}>
                {content}
            </span>
        );
    }
