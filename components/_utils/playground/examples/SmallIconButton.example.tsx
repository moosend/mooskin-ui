...
export default (props: any) => {
    ...
    return(
        <fieldset style={{display: 'inline-block'}}>
            ...
            <SmallIconButton onClick={onClick} icon={'alarm'}/>
            ...
            <SmallIconButton onClick={onClick} icon={'power'} inverseStyle/>
            <SmallIconButton onClick={onClick} icon={'settings'} />
            <SmallIconButton onClick={onClick} icon={'verified'}/>
            ...
            <SmallIconButton onClick={onClick} icon={'play'} inverseStyle/>
            ...
            <SmallIconButton onClick={onClick} icon={'mail outline'}/>
            ...
            <SmallIconButton onClick={onClick} icon={'send'} inverseStyle/>
            ...
            <SmallIconButton onClick={onClick} icon={'dropdown'}/>
            ...
            <SmallIconButton onClick={onClick} icon={'person add'} inverseStyle/>
            <SmallIconButton onClick={onClick} icon={'notifications'}/>
