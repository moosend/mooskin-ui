        ...
        const tree = mount(
            <Tabs activeItem={3} onClickTab={func}>
                <Tab activeId={1}>
                    ...
                    <TabContent><div>{`Content for item with index: 1`}</div></TabContent>
                </Tab>
                <Tab activeId={2}>
                    <TabHeader>{`Item: 2`}</TabHeader>
                    <TabContent><div>{`Content for item with index: 2`}</div></TabContent>
                </Tab>
                <Tab activeId={3}>
                    <TabHeader>{`Item: 3`}</TabHeader>
                    <TabContent><div>{`Content for item with index: 3`}</div></TabContent>
                </Tab>
                <Tab activeId={4}>
                    <TabHeader>{`Item: 4`}</TabHeader>
                    <TabContent><div>{`Content for item with index: 4`}</div></TabContent>
                </Tab>
                <Tab activeId={5}>
                    <TabHeader>{`Item: 5`}</TabHeader>
                    <TabContent><div>{`Content for item with index: 5`}</div></TabContent>
                </Tab>
                <Tab activeId={6}>
                    <TabHeader>{`Item: 6`}</TabHeader>
                    <TabContent><div>{`Content for item with index: 6`}</div></TabContent>
                </Tab>
            </Tabs>
        );
